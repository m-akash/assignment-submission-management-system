...
namespace AssignmentSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260809193525_SplitClassGradeAndSection")]
    partial class SplitClassGradeAndSection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssignmentSystem.Domain.AcademicYears.AcademicYear", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("StartDate")
                        .HasDatabaseName("ix_academic_years_start_date");
            ...
            modelBuilder.Entity("AssignmentSystem.Domain.Assignments.Assignment", b =>
                {
                    ...
                    b.Property<string>("DescriptionText")
                        ...
                        .HasComputedColumnSql("replace(replace(replace(replace(regexp_replace(description, '<[^>]*>', ' ', 'g'), '&nbsp;', ' '), '&lt;', '<'), '&gt;', '>'), '&amp;', '&')", true);
            ...
            modelBuilder.Entity("AssignmentSystem.Domain.Classes.Class", b =>
                {
                    ...
                    b.HasIndex("Level", "Section")
                        .IsUnique()
                        .HasDatabaseName("ix_classes_level_section");
            ...
            modelBuilder.Entity("AssignmentSystem.Domain.Enrollments.StudentEnrollment", b =>
                {
                    ...
                    b.HasIndex("AcademicYearId")
                        .HasDatabaseName("ix_student_enrollments_academic_year_id");
                    ...
                    b.HasIndex("StudentId", "ClassId", "AcademicYearId")
                        .IsUnique()
                        .HasDatabaseName("ix_student_enrollments_student_id_class_id_academic_year_id");
            ...
            modelBuilder.Entity("AssignmentSystem.Domain.Enrollments.StudentEnrollment", b =>
                {
                    b.HasOne("AssignmentSystem.Domain.AcademicYears.AcademicYear", "AcademicYear")
                        .WithMany("Enrollments")
                        .HasForeignKey("AcademicYearId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_student_enrollments_academic_years_academic_year_id");
