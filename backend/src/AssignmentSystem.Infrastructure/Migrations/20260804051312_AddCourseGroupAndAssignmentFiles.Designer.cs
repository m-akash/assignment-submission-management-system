...
namespace AssignmentSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260804051312_AddCourseGroupAndAssignmentFiles")]
    partial class AddCourseGroupAndAssignmentFiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssignmentSystem.Domain.Departments.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AssignmentSystem.Domain.Groups.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AssignmentSystem.Domain.Courses.Course", b =>
                {
                    b.HasOne("AssignmentSystem.Domain.Departments.Department", "Department")
                        .WithMany()
                    ...
                    b.HasOne("AssignmentSystem.Domain.Groups.Group", "Group")
                        .WithMany()
