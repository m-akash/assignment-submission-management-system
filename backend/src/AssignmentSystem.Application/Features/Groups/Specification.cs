...
internal sealed class GroupByCodeSpecification : Specification<Group>
{
    public GroupByCodeSpecification(string code)
    {
...
internal sealed class GroupsPagedSpecification : Specification<Group>
{
    public GroupsPagedSpecification(string? search, int page, int pageSize)
    {
        ApplyNoTracking();
