...
{
    // TeacherCount/TeacherNames/AssignmentCount have no source property on ClassCourse — they
    // are aggregates the handler fills in afterwards, not something Mapperly can map.
    ...
    [MapperIgnoreTarget(nameof(ClassCourseDto.TeacherNames))]
