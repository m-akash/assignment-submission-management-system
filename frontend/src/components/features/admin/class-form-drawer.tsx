...
export function ClassFormDrawer({
  ...
  return (
    <FormDrawer
      ...
      description="A class is a grade and a section. One class per pair — a grade can hold as many sections as it needs."
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Combobox
            ...
            // Clearing keeps the field empty instead of falling through to Number('') === 0,
            // which would leave a grade the school does not run sitting on the trigger.
            onChange={(value) =>
              form.setValue('level', value === '' ? '' : Number(value), { shouldValidate: true })
            }
